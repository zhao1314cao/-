<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入评论人名称查询" style="width: 200px; margin-right: 10px" v-model="name"></el-input>
...
<!--            <el-button size="mini" type="primary" plain @click="handleEdit(scope.row)">编辑</el-button>-->
    ...
    <el-dialog name="信息" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
      ...
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="评论人" prop="userId">
          <el-input v-model="form.userName" placeholder="评论人"></el-input>
        </el-form-item>
    ...
    <el-dialog title="评论详情" :visible.sync="fromVisible1" width="50%" :close-on-click-modal="false" :append-to-body="true" destroy-on-close>
      <div class="w-e-text">
