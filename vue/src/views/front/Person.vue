    ...
    <el-tabs v-model="activeName" @tab-click="clickTab">
      ...
      <el-tab-pane label="我发表的博客" name="我发表的博客">
        ...
        <div style="margin-top: 10px">
          <BlogList type='user' :show-opt="true" />
        </div>
      </el-tab-pane>
      <el-tab-pane label="我报名的活动" name="我报名的活动">
        <ActivityList type="user" :span="5" />
      </el-tab-pane>
      <el-tab-pane label="我的点赞" name="我的点赞">
          ...
          <div style="margin-top: 10px">
            ...
            <ActivityList v-if="likesCurrent==='活动'" :span="8" type="like"></ActivityList>
          </div>
      </el-tab-pane>
      <el-tab-pane label="我的收藏" name="我的收藏">
          ...
          <div style="margin-top: 10px">
            <BlogList v-if="collectCurrent==='博客'" type="collect"></BlogList>
            <ActivityList v-if="collectCurrent==='活动'" :span="8" type="collect"></ActivityList>
          </div>
      </el-tab-pane>
      <el-tab-pane label="我的评论" name="我的评论">
          ...
          <div style="margin-top: 10px">
            <BlogList v-if="commentCurrent==='博客'" type="comment"></BlogList>
            <ActivityList v-if="commentCurrent==='活动'" :span="8" type="comment"></ActivityList>
          </div>
      </el-tab-pane>
    </el-tabs>
    <Footer/>
...
.active{
  background-color: #2a60c9;color: white
}
</style>